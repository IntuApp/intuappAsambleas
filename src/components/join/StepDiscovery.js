...
export default function StepDiscovery({ verificationQueue, onContinue }) {
  return (
    <div className="flex flex-col md:items-center md:text-center md:w-[552px] gap-10 animate-in fade-in zoom-in-95 duration-500 gap-8">
      ...
      <div className="flex flex-wrap items-center justify-center gap-4 w-full max-h-[400px] overflow-y-auto md:p-2 scrollbar-hide">
