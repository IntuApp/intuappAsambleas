        ...
        <div className="flex flex-col gap-6">
          <div className="flex gap-4 items-start">
            ...
            <div className="flex-1">
              ...
              <button
                className="flex items-center gap-2 border border-[#0E3C42] text-[#0E3C42] px-4 py-2 rounded-full font-medium hover:bg-gray-50 transition"
                onClick={() => {
                ...
                <div className="flex-1 flex flex-col gap-4">
                  ...
                  <div className="border-2 border-dashed border-[#94A2FF] bg-[#F5F7FF] rounded-xl p-8 flex flex-col items-center justify-center text-center min-h-[200px] relative">
                    ...
                    <p className="text-xs text-gray-500 mt-4 max-w-xs">
                      Debe usar la misma plantilla descargada anteriormente. Si
                      usa otro archivo, el sistema no reconocerá la información
                    </p>
                  </div>
