        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
          <div className="flex items-center justify-between mb-6">
            ...
            <button
              onClick={() =>
                router.push(
                  `/superAdmin/operadores/${id}/entity/${entityId}/crear-asamblea`
                )
              }
              className="flex items-center gap-2 bg-[#8B9DFF] hover:bg-[#7a8ce0] text-white px-6 py-3 rounded-xl font-semibold shadow-md transition"
            >
              <Plus size={20} />
              Crear Asamblea
            </button>
          ...
          <div className="flex gap-4 mb-6">
            ...
            <select
              ...
              className="border border-gray-200 rounded-xl px-4 py-3 outline-none focus:border-[#8B9DFF] bg-white min-w-[140px] transition"
            >
                        ...
                        >
                          ...
                          <td className="py-4 px-6">
                            <button
                              onClick={() =>
                                router.push(
                                  `/superAdmin/operadores/${id}/entity/${entityId}/assembly/${assembly.id}`
                                )
                              }
